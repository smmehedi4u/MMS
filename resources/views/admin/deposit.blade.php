...
@section('content')
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" form="deposit-form">Save</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel">Edit Deposit</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="edit-form" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        <label>Amount</label>
                                        <input type="integer" id="edit-amount" name="amount" class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg">
    ...
    <script>
        $(document).ready(function () {
                ...
                "columns": [
                    ...
                    { "data": "date" },
                    {
                        ...
                        "render": function (data, type, row) {
                            return '<a href="#" class="btn btn-sm btn-success edit-btn" data-id="'+data.id+'" data-user_id="'+data.user_id+'" data-amount="'+data.amount+'" data-date="'+data.date+'">Edit</a> ' +
            ...
            $('#deposit-form').submit(function (e) {
                e.preventDefault();
                const depositdata = new FormData(this);
